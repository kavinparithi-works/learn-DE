...
const SECTIONS = [
  { title: 'Level 3  -  SQL Foundations', items: [
    ...
    { id: 'sql-case',     label: 'CASE WHEN Expressions' },
    { id: 'sql-strings',  label: 'String Functions' },
    { id: 'sql-dates',    label: 'Date / Time Functions' },
  ...
  { title: 'Level 4  -  SQL Intermediate', items: [
    ...
    { id: 'sql-setops',     label: 'SET Operations (UNION, INTERSECT, EXCEPT)' },
    { id: 'sql-cte',        label: 'CTEs and Recursive CTEs' },
  ...
  { title: 'Level 5  -  SQL Mastery', items: [
    ...
    { id: 'sql-performance',   label: 'Query Performance Tuning' },
  ]},
]
