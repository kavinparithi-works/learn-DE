...
# For now, multiprocessing + asyncio remain the production patterns.`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-execution')) { await unmarkTopicComplete('py-execution'); onUnmark('py-execution') } else { await markTopicComplete('py-execution'); onComplete('py-execution') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# plugins = ["pydantic.mypy"]`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-types')) { await unmarkTopicComplete('py-types'); onUnmark('py-types') } else { await markTopicComplete('py-types'); onComplete('py-types') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
combined = today_counts + yesterday_counts`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-structures')) { await unmarkTopicComplete('py-structures'); onUnmark('py-structures') } else { await markTopicComplete('py-structures'); onComplete('py-structures') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# but uses O(1) memory vs O(n)  -  the right trade-off for large data.`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-comprehensions')) { await unmarkTopicComplete('py-comprehensions'); onUnmark('py-comprehensions') } else { await markTopicComplete('py-comprehensions'); onComplete('py-comprehensions') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def _(obj: pd.DataFrame) -> str:
    return obj.to_csv(index=False)`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-functions')) { await unmarkTopicComplete('py-functions'); onUnmark('py-functions') } else { await markTopicComplete('py-functions'); onComplete('py-functions') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# [1200, 2050, 4150, 4820, 6720]`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-generators')) { await unmarkTopicComplete('py-generators'); onUnmark('py-generators') } else { await markTopicComplete('py-generators'); onComplete('py-generators') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def process_event(record: dict) -> dict:
    return {**record, "amount_usd": record["amount"] / 100}`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-decorators')) { await unmarkTopicComplete('py-decorators'); onUnmark('py-decorators') } else { await markTopicComplete('py-decorators'); onComplete('py-decorators') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
full_etl = ingest | enrich   # DataPipeline(name='ingest|enrich', stages=6)`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-oop')) { await unmarkTopicComplete('py-oop'); onUnmark('py-oop') } else { await markTopicComplete('py-oop'); onComplete('py-oop') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def pipeline_stage(name: str, conn):
    ...
    try:
        ...
        raise`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-context')) { await unmarkTopicComplete('py-context'); onUnmark('py-context') } else { await markTopicComplete('py-context'); onComplete('py-context') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
log.audit("load_complete", rows_affected=84_321, target_table="fact_sales")`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-errors')) { await unmarkTopicComplete('py-errors'); onUnmark('py-errors') } else { await markTopicComplete('py-errors'); onComplete('py-errors') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
async def fetch_with_timeout(url: str) -> dict | None:
    try:
        ...
        return None`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-async')) { await unmarkTopicComplete('py-async'); onUnmark('py-async') } else { await markTopicComplete('py-async'); onComplete('py-async') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def atomic_write_json(data: dict, path: Path) -> None:
    ...
    try:
        ...
        raise`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-io')) { await unmarkTopicComplete('py-io'); onUnmark('py-io') } else { await markTopicComplete('py-io'); onComplete('py-io') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def validate_table_name(name: str) -> str:
    ...
    return name`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-regex')) { await unmarkTopicComplete('py-regex'); onUnmark('py-regex') } else { await markTopicComplete('py-regex'); onComplete('py-regex') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# (place in tests/ directory)`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-testing')) { await unmarkTopicComplete('py-testing'); onUnmark('py-testing') } else { await markTopicComplete('py-testing'); onComplete('py-testing') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# CMD ["python", "pipeline.py"]`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-packages')) { await unmarkTopicComplete('py-packages'); onUnmark('py-packages') } else { await markTopicComplete('py-packages'); onComplete('py-packages') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
df.to_parquet("output.parquet", engine="pyarrow", compression="snappy", index=False)`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-pandas')) { await unmarkTopicComplete('py-pandas'); onUnmark('py-pandas') } else { await markTopicComplete('py-pandas'); onComplete('py-pandas') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
def run_upsert(records: list[dict], table: str) -> int:
    ...
    with engine.begin() as conn:   # engine.begin() = auto-commit transaction
        ...
        return result.rowcount`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-db')) { await unmarkTopicComplete('py-db'); onUnmark('py-db') } else { await markTopicComplete('py-db'); onComplete('py-db') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
async def paginate_cursor(client: httpx.AsyncClient, url: str) -> list[dict]:
    ...
    return all_records`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-http')) { await unmarkTopicComplete('py-http'); onUnmark('py-http') } else { await markTopicComplete('py-http'); onComplete('py-http') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
wc -l /data/processed/events_2024-01-15.jsonl   # count processed records`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-linux')) { await unmarkTopicComplete('py-linux'); onUnmark('py-linux') } else { await markTopicComplete('py-linux'); onComplete('py-linux') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
    ...
    steps:
      ...
      - name: Upload coverage
        uses: codecov/codecov-action@v4`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-git')) { await unmarkTopicComplete('py-git'); onUnmark('py-git') } else { await markTopicComplete('py-git'); onComplete('py-git') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
for raw_record in raw_batch:
    try:
        ...
        invalid_records.append({"record": raw_record, "errors": e.errors()})`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-pydantic')) { await unmarkTopicComplete('py-pydantic'); onUnmark('py-pydantic') } else { await markTopicComplete('py-pydantic'); onComplete('py-pydantic') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# dist/`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-docker')) { await unmarkTopicComplete('py-docker'); onUnmark('py-docker') } else { await markTopicComplete('py-docker'); onComplete('py-docker') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# kubectl delete jobs --field-selector status.successful=1 -n data-pipelines`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-k8s')) { await unmarkTopicComplete('py-k8s'); onUnmark('py-k8s') } else { await markTopicComplete('py-k8s'); onComplete('py-k8s') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
# |                      | Spark DQ      | data platforms     | validation|            |`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-deequ')) { await unmarkTopicComplete('py-deequ'); onUnmark('py-deequ') } else { await markTopicComplete('py-deequ'); onComplete('py-deequ') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
...
total = sum(row.amount for row in iter_records(parquet_files))  # O(1) memory`}</CodeBlock>
          ...
          <button onClick={async () => { if (completed.has('py-memory')) { await unmarkTopicComplete('py-memory'); onUnmark('py-memory') } else { await markTopicComplete('py-memory'); onComplete('py-memory') } }} className="complete-btn-inline" style={{ marginTop: 16 }}>Mark Complete ✓</button>
        </section>
