...
# For now, multiprocessing + asyncio remain the production patterns.`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-execution'); onComplete('py-execution') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# plugins = ["pydantic.mypy"]`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-types'); onComplete('py-types') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
combined = today_counts + yesterday_counts`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-structures'); onComplete('py-structures') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# but uses O(1) memory vs O(n)  -  the right trade-off for large data.`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-comprehensions'); onComplete('py-comprehensions') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def _(obj: pd.DataFrame) -> str:
    return obj.to_csv(index=False)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-functions'); onComplete('py-functions') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# [1200, 2050, 4150, 4820, 6720]`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-generators'); onComplete('py-generators') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def process_event(record: dict) -> dict:
    return {**record, "amount_usd": record["amount"] / 100}`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-decorators'); onComplete('py-decorators') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
full_etl = ingest | enrich   # DataPipeline(name='ingest|enrich', stages=6)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-oop'); onComplete('py-oop') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def pipeline_stage(name: str, conn):
    ...
    try:
        ...
        raise`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-context'); onComplete('py-context') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
log.audit("load_complete", rows_affected=84_321, target_table="fact_sales")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-errors'); onComplete('py-errors') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
async def fetch_with_timeout(url: str) -> dict | None:
    try:
        ...
        return None`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-async'); onComplete('py-async') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def atomic_write_json(data: dict, path: Path) -> None:
    ...
    try:
        ...
        raise`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-io'); onComplete('py-io') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def validate_table_name(name: str) -> str:
    ...
    return name`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-regex'); onComplete('py-regex') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# (place in tests/ directory)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-testing'); onComplete('py-testing') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# CMD ["python", "pipeline.py"]`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-packages'); onComplete('py-packages') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
df.to_parquet("output.parquet", engine="pyarrow", compression="snappy", index=False)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-pandas'); onComplete('py-pandas') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
def run_upsert(records: list[dict], table: str) -> int:
    ...
    with engine.begin() as conn:   # engine.begin() = auto-commit transaction
        ...
        return result.rowcount`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-db'); onComplete('py-db') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
async def paginate_cursor(client: httpx.AsyncClient, url: str) -> list[dict]:
    ...
    return all_records`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-http'); onComplete('py-http') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
wc -l /data/processed/events_2024-01-15.jsonl   # count processed records`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-linux'); onComplete('py-linux') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
    ...
    steps:
      ...
      - name: Upload coverage
        uses: codecov/codecov-action@v4`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-git'); onComplete('py-git') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
for raw_record in raw_batch:
    try:
        ...
        invalid_records.append({"record": raw_record, "errors": e.errors()})`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-pydantic'); onComplete('py-pydantic') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# dist/`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-docker'); onComplete('py-docker') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# kubectl delete jobs --field-selector status.successful=1 -n data-pipelines`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-k8s'); onComplete('py-k8s') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# |                      | Spark DQ      | data platforms     | validation|            |`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-deequ'); onComplete('py-deequ') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
total = sum(row.amount for row in iter_records(parquet_files))  # O(1) memory`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('py-memory'); onComplete('py-memory') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
