...
const SECTIONS = [
  { title: 'Level 8 - Delta Lake', items: [
    { id: 'delta-intro', label: 'Delta Lake Fundamentals' },
    { id: 'delta-acid', label: 'ACID Transactions' },
    { id: 'delta-write-modes', label: 'Write Operations' },
    { id: 'delta-merge', label: 'MERGE Deep Dive' },
    { id: 'delta-schema', label: 'Schema Enforcement & Evolution' },
    { id: 'delta-time-travel', label: 'Time Travel' },
    { id: 'delta-cdf', label: 'Change Data Feed' },
    { id: 'delta-optimize', label: 'OPTIMIZE' },
    { id: 'delta-zorder', label: 'Z-ORDER Clustering' },
    { id: 'delta-vacuum', label: 'VACUUM' },
    { id: 'delta-liquid', label: 'Liquid Clustering' },
    { id: 'delta-constraints', label: 'Table Constraints' },
    { id: 'delta-props', label: 'Table Properties' },
    { id: 'delta-partitioning', label: 'Partitioning Strategy' },
    { id: 'delta-performance', label: 'Delta Performance Tuning' },
  ]},
  { title: 'Databricks + Unity Catalog', items: [
    { id: 'databricks-platform', label: 'Databricks Platform Overview' },
    { id: 'databricks-uc', label: 'Unity Catalog Deep Dive' },
    { id: 'databricks-uc-permissions', label: 'UC Permissions' },
    { id: 'databricks-uc-rowcol', label: 'Row Filters & Column Masking' },
    { id: 'databricks-dlt', label: 'Delta Live Tables (DLT)' },
    { id: 'databricks-autoloader', label: 'Auto Loader' },
    { id: 'databricks-workflows', label: 'Workflows / Lakeflow' },
    { id: 'databricks-dab', label: 'Asset Bundles (DAB)' },
