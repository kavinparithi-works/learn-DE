...
#          lastModified, partitionColumns, numFiles, sizeInBytes, properties, minReaderVersion, minWriterVersion`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-intro'); onComplete('delta-intro') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# Serializable = strongest; WriteSerializable = default (read-your-own-writes)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-acid'); onComplete('delta-acid') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
new_events.write \
    ...
    .save("/mnt/datalake/silver/events")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-write-modes'); onComplete('delta-write-modes') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# numSourceRows, numTargetFilesAdded, numTargetFilesRemoved`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-merge'); onComplete('delta-merge') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
print(dt.toDF().schema.simpleString())`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-schema'); onComplete('delta-schema') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
""")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-time-travel'); onComplete('delta-time-travel') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
query.awaitTermination()`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-cdf'); onComplete('delta-cdf') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
print("OPTIMIZE is safe to run in production on live tables.")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-optimize'); onComplete('delta-optimize') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
""")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-zorder'); onComplete('delta-zorder') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# Error: No file found for path ... It may have been deleted by VACUUM.`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-vacuum'); onComplete('delta-vacuum') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
-- Partitioning:       only for very low cardinality (e.g., date with ~365 partitions/year)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-liquid'); onComplete('delta-liquid') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
-- They do NOT retroactively validate existing data (add constraint = future writes only)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-constraints'); onComplete('delta-constraints') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
UNSET TBLPROPERTIES ('delta.autoOptimize.autoCompact');`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-props'); onComplete('delta-props') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
spark.sql("ALTER TABLE production.silver.events CLUSTER BY (event_date, region)")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-partitioning'); onComplete('delta-partitioning') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# Provides row counts and column histograms to Catalyst for better join ordering`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('delta-performance'); onComplete('delta-performance') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# Cost: Photon DBUs are priced higher than standard DBUs`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-platform'); onComplete('databricks-platform') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
WHERE target_table_full_name = 'production.silver.customers';`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-uc'); onComplete('databricks-uc') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
-- they CAN read the table (additive wins).`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-uc-permissions'); onComplete('databricks-uc-permissions') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
-- Column Masks: email -> production.silver.mask_email`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-uc-rowcol'); onComplete('databricks-uc-rowcol') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# ORDER BY timestamp DESC LIMIT 100`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-dlt'); onComplete('databricks-dlt') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
# _rescued_data: null for week 1 rows, null for week 2 (new column handled cleanly)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-autoloader'); onComplete('databricks-autoloader') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
  ...
  "webhook_notifications": {
    "on_failure": [{"id": "pagerduty-webhook-id"}]
          ...
          <button onClick={async () => { await markTopicComplete('databricks-workflows'); onComplete('databricks-workflows') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
#      env: DATABRICKS_HOST, DATABRICKS_TOKEN (from GitHub secrets)`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-dab'); onComplete('databricks-dab') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
-- Declarative, managed incremental ingestion without DLT notebook`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-sql'); onComplete('databricks-sql') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
ORDER BY event_time DESC;`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('databricks-sharing'); onComplete('databricks-sharing') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
""")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('iceberg-intro'); onComplete('iceberg-intro') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
spark.read.option("tag", "monthly_snapshot_jan_2024").table("glue_catalog.db.events")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('iceberg-features'); onComplete('iceberg-features') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
delete_df.write \
    ...
    .save("s3://warehouse/silver/orders/")`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('hudi-intro'); onComplete('hudi-intro') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
...
#   - You need incremental processing built into the table format natively`}</CodeBlock>
          ...
          <button onClick={async () => { await markTopicComplete('format-comparison'); onComplete('format-comparison') }} style={{ marginTop: 16, padding: '8px 20px', borderRadius: 'var(--radius-full)', background: 'var(--green-500)', color: 'white', border: 'none', fontWeight: 700, cursor: 'pointer', fontSize: '.84rem' }}>Mark Complete ✓</button>
        </section>
